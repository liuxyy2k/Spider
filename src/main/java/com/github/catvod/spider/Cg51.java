...
public class Cg51 extends Spider {
    ...
    private static final String siteUrl = "https://proxy.edgeone.pp.ua/proxy?url=https%3A%2F%2Fcarrier.ujaumgp.cc";
...
//    }
    ...
    public String homeContent(boolean filter) throws Exception {
        ...
        String[] typeIdList = {"wpcz","mrdg","rdsj","bkdg","whhl","xsxy","whmx","thjx"};
        String[] typeNameList = {"今日吃瓜","每日大瓜","热门吃瓜","必看大瓜","网红黑料","学生学校","明星黑料","探花精选"};
